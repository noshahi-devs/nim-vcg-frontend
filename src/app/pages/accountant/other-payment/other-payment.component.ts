    ...
    const voucherParts = ['Bank Copy', 'Office Copy', 'Student Copy'].map(copyName => `
      <div class="voucher-part">
        ...
        <div class="v-student-panel">
          <div class="v-row"><strong>Receipt #:</strong> <span style="color:var(--primary-color); font-weight:bold;">O-${payment.othersPaymentId ? String(payment.othersPaymentId).padStart(5, '0') : 'NEW'}</span></div>
